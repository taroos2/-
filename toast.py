...
async def on_message(message):
    ...
    if message.content.startswith("토스트 아니야"):
        await client.send_message(message.channel, ("웅.."))
        
    if message.content.startswith("토스트 응 아니야"):
        await client.send_message(message.channel, ("아니야?"))
